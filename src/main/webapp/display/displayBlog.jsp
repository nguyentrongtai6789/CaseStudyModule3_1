...
<html>
<head>
    <title>Danh sách Blog</title>
</head>
<head>
    <meta charset="utf-8">
    <meta content="width=device-width, initial-scale=1.0" name="viewport">

    <title>Blog entertainment</title>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a href="single-post.html">Bài Đăng</a></li>
                <li class="dropdown"><a href="category.html"><span>Thể Loại</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                    <ul>
                        <li><a href="search-result.html">Tìm Kiếm</a></li>
                ...
                <li><a href="bost.html">Contact</a></li>
            </ul>
        </nav><!-- .navbar -->
            ...
            <div class="row g-5">
                ...
                <div class="col-6 col-lg-2">
                    ...
                    <ul class="footer-links list-unstyled">
                        ...
                        <li><a href="bost.html"><i class="bi bi-chevron-right"></i> Contact</a></li>
                    </ul>
                </div>
                <div class="col-6 col-lg-2">
